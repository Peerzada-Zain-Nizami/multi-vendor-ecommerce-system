        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">Next Shelf</h4>
                </div>
            </div>
            <!--End Page header-->
            ...
            <div class="row">
                ...
                @endif
                    ...
                    @endif
                <div class="col-sm-8">
                    <form action="{{route('wadmin.stockMove.place.update')}}" method="post">
                        @csrf
                        <div class="form-group">
                            <input type="text" name="old_shelf_code" value="{{$shelf}}" hidden>
                            <label>Shelf Barcode Search</label>
