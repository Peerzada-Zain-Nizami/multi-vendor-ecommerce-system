                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Session::has('success'))
                                <div class="alert alert-light-success" role="alert">
                                    <button type="button" class="btn-close text-success mr-negative-16" data-bs-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>{{__('messages.stock')}}</strong> {{Session::get('success')}}
                                </div>
                            @endif
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('name'))is-invalid @endif" name="name" placeholder="{{__('messages.your-name')}}" value="{{Auth::user()->name}}">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="{{__('messages.email-address')}}" value="{{Auth::user()->email}}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('address'))is-invalid @endif" name="address" placeholder="{{__('messages.address')}}" value="{{Auth::user()->address}}">
...
@section('query')
    <script type="text/javascript">
                ...
                $.ajax({
                    url: '{{route('wadmin.profile.image')}}',
                    type: 'POST',
                    data: formData,
             ...
             $('.pass').click(function(){
                $.ajax({
                    url:'{{route('wadmin.profile.password')}}',
                    type:'POST',
                    data:$('#pass').serialize(),
                    success:function(response){
                        console.log(response);
             ...
             $('.profile').click(function(){
                $.ajax({
                    url:'{{route('wadmin.profile.update')}}',
                    type:'POST',
