                            ...
                            <table id="example" class="table table-responsive-lg-sm table-bordered text-nowrap key-buttons">
                                ...
                                @foreach($plans as $plan)
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.user.view',['id'=>$plan->transfer_to])}}">{{$admin->name}}</a></td>
                                        <td><a href="{{route('admin.user.view',['id'=>$plan->transfer_from])}}">{{$seller->name}}</a></td>
                                        <td>{{$plan_data->type}}</td>
                                        <td class="text-warning">{{Crypt::decrypt($payment_price->previous_balance)}}</td>
                                        <td class="text-success">{{Crypt::decrypt($payment_price->cash_in)}}</td>
