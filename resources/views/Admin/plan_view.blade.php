                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive-lg">
                                    <table class="table table-borderless mb-1">
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="text-start"><span class="ms-auto">{{__('messages.product-category')}}</span></td>
                                            <td class="text-end"><span class="ms-auto">{{__('messages.product-price-discount')}}</span></td>
                                        </tr>
                                        @if ($products)
                                        @foreach($products as $product)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><span class="ms-auto">{{$j_product->price}}@if($j_product->method == "percentage")% @else {{__('messages.fixed-price')}} @endif</span></td>
                                            </tr>
                                        @endforeach
                                         @endif
                                        </tbody>
                                ...
                                <div class="table-responsive-lg">
                                    <table class="table table-borderless mb-1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end"><span class="ms-auto">{{$shipping->discount}}@if($shipping->method == "percentage")% @else {{__('messages.fixed-price')}} @endif</span></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive-lg">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end"><span class="ms-auto">{{$cancellation->discount}}@if($cancellation->method == "percentage")% @else {{__('messages.fixed-price')}} @endif</span></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
