        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">{{__('messages.stock-in')}}
                </div>
            </div>
            <!--End Page header-->
            ...
            <div class="row">
                ...
                @endif
                    ...
                    @endif
                <div class="col-sm-8">
                    <form action="{{route('wadmin.stockIn.place.add.order.return')}}" method="GET">
                        @csrf
                        ...
                        <input type="submit" class="btn btn-primary" value="{{__('messages.Go')}}">
                    </form>
                </div>
                <div class="col-sm-4">
