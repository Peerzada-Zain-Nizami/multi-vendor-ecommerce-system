...
<!-- Mirrored from laravel.spruko.com/azea/ltr/error500 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 14:42:53 GMT -->
                    ...
                    <div class="col-md-12">
                        <div class="mt-lg-7">
                            <div class="text-white">
                                ...
                                <h1 class="h3  mb-3 font-weight-bold">Error: SMSA Credential not Found</h1>
                                <p class="h5 font-weight-normal leading-normal">It seems your SMSA credentials are missing. Please add the credentials to proceed. Thank.</p>
                                <a class="btn btn-light text-primary mb-5 fs-18" href="/">Back</a>
                                <a class="btn text-light border-light mb-5 ms-2 fs-18" href="{{route('admin.smsa.credentials')}}">Add Credentials</a>
                            </div>
                        </div>
                    </div>
                </div>
