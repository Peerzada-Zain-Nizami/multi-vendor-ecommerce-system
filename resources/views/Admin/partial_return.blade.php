...
@section('content')
    ...
    <div class="app-content main-content">
        <div class="side-app">
            ...
            <!--div-->
            <div class="row">
                <form action="{{route('admin.manage.invoice.return.partial.request',$result->invoice_no)}}" method="post">
                    @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input name="quantity[]" min="0" max="{{$return->quantity-$sold}}" class="form-control" type="number" value="{{old() ? old('quantity')[$loop->index] : 0}}" required>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="form-group text-center">
                    <input type="submit" class="btn btn-primary" value="{{__('messages.send-request')}}">
                </div>
                </form>
            </div>
            <!-- End Row-->
