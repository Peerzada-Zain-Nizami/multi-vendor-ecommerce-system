        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">{{ __('messages.add-warehouse-admin') }}</h4>
                </div>
            </div>
            <!--End Page header-->
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('messages.warehouse-admin-information') }}</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="waadmin" class="row g-3 needs-validation">
                                <div id="add_g_error"></div>
                                <div class="col-md-7 position-relative">
                                    <label for="validationTooltip02"
                                        class="form-label">{{ __('messages.warehouse-admin-name') }}</label>
                                ...
                                <div class="col-md-7 position-relative">
                                    <label for="validationTooltipUsername"
                                        class="form-label">{{ __('messages.warehouse-admin-email') }}</label>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary waadmin"
                                        type="button">{{ __('messages.add-warehouse-admin') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('query')
    <script type="text/javascript">
        $(Document).ready(function() {
            ...
            $('.waadmin').click(function() {
                $.ajax({
                    url: '{{ route('admin.Wadmin.add') }}',
                    type: 'POST',
                    data: $('#waadmin').serialize(),
