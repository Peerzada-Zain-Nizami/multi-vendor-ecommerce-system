        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">{{__('messages.sale-reports')}}</h4>
                </div>
            ...
            <div class="card" id="filter" @if($filter != 1)style="display: none;"@endif>
                ...
                <form action="{{route('supplier.sale.reports.filter')}}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
