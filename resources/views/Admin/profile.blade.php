                ...
                <div class="col-xl-3 col-lg-4">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <form id="profile_img" enctype="multipart/form-data">
                               <div id="add_g_error"></div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary profile_img" type="button">{{__('messages.upload')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <form id="pass">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if (Session::has('password'))
                                    <div class="alert alert-light-success" role="alert">
                                        <button type="button" class="btn-close text-success mr-negative-16"
                                            data-bs-dismiss="alert" aria-hidden="true">×</button>
                                        <strong>{{ __('messages.well-done') }}</strong> {{ Session::get('password') }}
                                    </div>
                                @endif
                                {{-- @if (Session::has('password error'))
                                    <div class="alert alert-light-danger" role="alert">
                                        <button type="button" class="btn-close text-danger mr-negative-16"
                                            data-bs-dismiss="alert" aria-hidden="true">×</button>
                                        <strong>{{ __('messages.oopps') }}</strong> {{ Session::get('password error') }}
                                    </div>
                                @endif --}}
                                <div class="form-group">
                            ...
                            <div class="card-footer text-center">
                                <button class="btn btn-primary pass" type="button">{{__('messages.update')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="profile">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="city" placeholder="City" value="{{ Auth::user()->city }}">
                                            @if ($errors->has('city'))
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="form-control select2 @if ($errors->has('country')) is-invalid @endif"
                                                name="country">
                                                <option>{{ __('messages.select') }}</option>
                                                <option value="Saudia Arabia"
                                                    @if (Auth::user()->country == 'Saudia Arabia') selected @endif>
                                                    {{ __('messages.saudia-arabia') }}</option>
                                                <option value="Pakistan"
                                                    @if (Auth::user()->country == 'Pakistan') selected @endif>
                                                    {{ __('messages.pakistan') }}</option>
                                            </select>
                            ...
                            <div class="card-footer text-end">
                                <button class="btn btn-primary profile" type="button">{{__('messages.update')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
