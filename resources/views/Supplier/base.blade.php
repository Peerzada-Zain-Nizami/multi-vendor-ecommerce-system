...
for ($i=01;$i <=12;$i++)
{
	$data = \App\Models\CompanyOrder::where('supplier_id',$supplier_id)
...
<head>
	...
	<meta name="csrf-token" content="{{ csrf_token() }}">
		<!-- Title -->
		<title>{{__('messages.supplier|dashboard')}}</title>
	...
	<audio id="alert_sound" controlsList="nodownload">
            ...
            <!--aside open-->
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="{{route('supplier.dashboard')}}">
					...
					<ul class="side-menu app-sidebar3">
						...
						<li class="slide">
							<a class="side-menu__item"  href="{{route('supplier.dashboard')}}">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="{{route('supplier.company.catalog')}}" class="slide-item"> {{__('messages.company-catalog')}}</a></li>
							</ul>
							<ul class="slide-menu">
								<li><a href="{{route('supplier.catalog')}}" class="slide-item"> {{__('messages.my-catalog')}}</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                <i class="fe fe-briefcase side-menu__icon"></i>
							<span class="side-menu__label">{{__('messages.orders-management')}}</span></a>
							<ul class="slide-menu">
								<li><a href="{{route('supplier.myorder')}}" class="slide-item"> {{__('messages.my-orders')}}</a></li>
							</ul>
							<ul class="slide-menu">
								<li><a href="{{route('supplier.return')}}" class="slide-item"> {{__('messages.return-request')}}</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li><a href="{{route('supplier.sale.reports')}}" class="slide-item"> {{__('messages.sale-report')}}</a></li>
							</ul>
							<ul class="slide-menu">
								<li><a href="{{route('supplier.return.reports')}}" class="slide-item"> {{__('messages.return-report')}}</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li><a href="{{route('supplier.wallet')}}" class="slide-item"> {{__('messages.my-wallet')}}</a></li>
							</ul>
							<ul class="slide-menu">
								<li><a href="{{route('supplier.transhistory')}}" class="slide-item"> {{__('messages.transaction-history')}}</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li><a href="{{route('supplier.profile')}}" class="slide-item">{{__('messages.my-profile')}}</a></li>
							</ul>
						</li>
					</ul>
				</aside>
												...
												<div class="d-flex order-lg-2">
													...
													<div class="dropdown header-notify d-flex">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
															...
															<div id="notification_body" class="notify-menu">
															</div>

															<div class=" text-center p-2">
																<a href="{{route('supplier.notifications')}}" class="btn btn-primary btn-md fs-13 btn-block">{{__('messages.view-all')}}</a>
															</div>
														</div>
													</div>
													...
													<div class="dropdown profile-dropdown d-flex">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
															...
															<a class="dropdown-item d-flex" href="{{route('supplier.profile')}}">
		...
		<script type="text/javascript">
			...
			function see(id)
			{
				...
				$.ajax({
					url:"{{route('supplier.get.noti.see')}}",
					type:"POST",
					dataType:"json",
					data: data,
				})
