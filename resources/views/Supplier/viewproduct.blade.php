                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12 col-xl-7 mt-5">
                                        <h3>
                                            <p class="text-navy">{{$result->product_name}}</p>
                                        </h3>
                                        <h4>{{__('messages.category')}}: {{$result->category}}</h4>
                                        <h5>{{__('messages.status')}}: <span class="badge @if($result->status == "Active") bg-success-transparent @else bg-danger-transparent @endif">{{$result->status}}</span></h5>
                                        <div>
