        ...
        <div class="side-app">
            ...
            <div>
                ...
                <div class="text-center">
                    <form action="{{route('wadmin.stockOut.place.stock.update',$shelf->id)}}" method="post">
                        @csrf
...
@section('query')
    <script type="text/javascript">
        ...
        function selected_item(shelf_id)
        {
            ...
            console.log(data);
            $.ajax({
                url:'{{route('wadmin.stock.out.get.stock.length')}}',
                type:'POST',
                data:data,
        ...
        function auto_sync()
        {
            ...
            $.ajax({
                url:'{{route('wadmin.stock.place.stock_out')}}',
                type:'POST',
                data:data,
                success:function(response){
        ...
        $(document).on('click','.minus',function () {
            var id = $(this).attr("id");
            $.ajax({
                url:'{{route('wadmin.stockOut.place.stock.minus')}}',
                type:'post',
                data:{id:id},
        ...
        $(document).on('click','.plus',function () {
            var id = $(this).attr("id");
            $.ajax({
                url:'{{route('wadmin.stockOut.place.stock.plus')}}',
                type:'post',
                data:{id:id},
                success:function(data){
                    console.log(data);
        ...
        $(document).on('click','.del',function(){
            ...
            swal({
                ...
                .then((willDelete) => {
                    ...
                    if (willDelete) {
                        $.ajax({
                            url:'{{route('wadmin.stockOut.place.stock.del')}}',
                            type:'POST',
                            data:{id:id},
                            success:function(data){
                                load_data();
