@php
    ...
    $c_year = date('Y');
    for ($i = 01; $i <= 12; $i++) {
        $data = \App\Models\Orders::where('admin_id', $admin_id)
...
<head>
    ...
    <style>
        .not-paid {
            ...
            /* Set a background color to highlight the row */
        }
    </style>
</head>
            ...
            <aside class="app-sidebar">
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.category.list') }}" class="slide-item">
                                    {{ __('messages.manage-categories') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.business.model') }}" class="slide-item">
                                    {{ __('messages.business-model') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.tax.index') }}"
                                    class="slide-item">{{ __('messages.tax-management') }}</a></li>
                        </ul>
                        {{--                    <ul class="slide-menu"> --}}
                        {{--                        <li><a href="{{route('admin.woocommerce.setup')}}" class="slide-item">{{__('messages.woocommerce-setup')}}</a></li> --}}
                        {{--                    </ul> --}}
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.import.city') }}" class="slide-item">
                                    {{ __('messages.import-file') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.my.cities') }}" class="slide-item">
                                    {{ __('messages.our-cities') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.city.mapping') }}" class="slide-item">
                                    {{ __('messages.shipping-company-cities') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.cities.prices') }}" class="slide-item">
                                    {{ __('messages.city-price') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.seller.city') }}" class="slide-item">
                                    {{ __('messages.seller-cities') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.warehouse-management') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.warehouse.overview') }}" class="slide-item">
                                    {{ __('messages.overview') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.warehouse') }}"
                                    class="slide-item">{{ __('messages.manage-warehouse') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.shipping.plan.index') }}"
                                    class="slide-item">{{ __('messages.add-plan') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.seller.plan.manage') }}"
                                    class="slide-item">{{ __('messages.manage-plan') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.seller.plan.price.index') }}"
                                    class="slide-item">{{ __('messages.plane-price') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.product-management') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.product') }}" class="slide-item">
                                    {{ __('messages.add-product') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.product.manage') }}" class="slide-item">
                                    {{ __('messages.manage-product') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.product.catalog') }}" class="slide-item">
                                    {{ __('messages.catalog') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.invoice-management') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.invoice.new') }}" class="slide-item">
                                    {{ __('messages.create-invoice') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.invoice.checkout') }}" class="slide-item">
                                    {{ __('messages.invoice-checkout') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.manage.invoice') }}" class="slide-item">
                                    {{ __('messages.manage-invoices') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.manage.invoice.return') }}" class="slide-item">
                                    {{ __('messages.return-invoices') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.stock-management') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('stock.catalog') }}" class="slide-item">
                                    {{ __('messages.stock-catalog') }}</a></li>
                            <li><a href="{{ route('admin.stock.details') }}" class="slide-item">
                                    {{ __('messages.stock-details') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.woo.order.list') }}" class="slide-item">
                                    {{ __('messages.new-orders') }}</a></li>
                            <li><a href="{{ route('admin.woo.order.management') }}" class="slide-item">
                                    {{ __('messages.manage-orders') }}</a></li>
                            <li><a href="{{ route('admin.woo.refunded.order') }}" class="slide-item">
                                    {{ __('messages.refunded-orders') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.reports') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.invoice.reports') }}" class="slide-item">
                                    {{ __('messages.invoice-reports') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.return.reports') }}" class="slide-item">
                                    {{ __('messages.return-reports') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fe fe-briefcase side-menu__icon"></i>
                            <span class="side-menu__label">{{ __('messages.users-management') }}</span></a>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.users') }}" class="slide-item">
                                    {{ __('messages.my-users') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.users.wallets') }}" class="slide-item">
                                    {{ __('messages.users-wallets') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.users.transactions') }}" class="slide-item">
                                    {{ __('messages.users-transactions') }}</a>
                            </li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.Wadmin') }}" class="slide-item">
                                    {{ __('messages.add-warehouse-admin') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.subadmin') }}" class="slide-item">
                                    {{ __('messages.add-subadmin') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.supplier') }}" class="slide-item">
                                    {{ __('messages.add-supplier') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.seller') }}" class="slide-item">
                                    {{ __('messages.add-seller') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.wallet') }}" class="slide-item">
                                    {{ __('messages.my-wallet') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.transhistory') }}" class="slide-item">
                                    {{ __('messages.transaction-history') }}</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.profile') }}"
                                    class="slide-item">{{ __('messages.my-profile') }}</a></li>
                        </ul>
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.smsa.credentials') }}"
                                    class="slide-item">{{ __('messages.SMSA-Credentials') }}</a></li>
                        </ul>
                    </li>
                </ul>
            </aside>
                                        ...
                                        <div class="dropdown country-selector  d-flex">
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="javascript:void(0);"
                                                    ...
                                                    <img src="{{ asset('assets/images/flags/' . Config::get('languages')[App::getLocale()]['flag-icon'] . '.svg') }}"
                                                        alt="flag" class="me-2 country">
                                                        ...
                                                        @if ($lang != App::getLocale())
                                                            <a class="dropdown-item change-lang"
                                                                href="{{ route('lang.switch', $lang) }}"><img
                                                                    src="{{ asset('assets/images/flags/' . $language['flag-icon'] . '.svg') }}"
                                                                    alt="flag" class="me-2 country">
                                                                {{ $language['display'] }}</a>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                                <div class="text-center">
                                                    <div class="text-center user pb-0 font-weight-bold">
                                                        {{ Auth::user()->name }}</div>
                                                    <span
                                                        class="text-center user-semi-title">{{ Auth::user()->role }}</span>
