                    ...
                    <table id="example" class="table table-responsive-lg-sm table-hover table-bordered text-nowrap key-buttons">
                        ...
                        @foreach($results as $result)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{route('wadmin.company.return.view',['id'=> $result->id])}}"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input id="option1" onclick="opt('Full')" type="radio" class="custom-control-input opt" name="option" value="Full"/>
                                <span class="custom-control-label">{{__('messages.full-payment')}} (<span id="amount"></span>)</span>
                            </label>
                        </div>
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input id="option2" onclick="opt('Custom')" type="radio" class="custom-control-input opt" name="option" value="Custom"/>
