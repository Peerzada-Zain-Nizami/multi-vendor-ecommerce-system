...
<head>
    ...
    <audio id="beep_sound" controlsList="nodownload">
        <source src="{{asset('assets/beep.wav')}}" type="audio/wav">
    </audio>
        <!---Global-loader-->
            ...
            <!--aside open-->
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="{{route('wadmin.dashboard')}}">
					...
					<ul class="side-menu app-sidebar3">
						...
						<li class="slide">
							<a class="side-menu__item"  href="{{route('wadmin.dashboard')}}">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="{{route('wadmin.warehouse.overview')}}" class="slide-item"> {{__('messages.overview')}}</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
							...
							<ul class="slide-menu">
								<li><a href="{{route('wadmin.company.invoice')}}" class="slide-item"> {{__('messages.company-invoices')}}</a></li>
								<li><a href="{{route('wadmin.company.invoice.returns')}}" class="slide-item"> {{__('messages.company-return')}}</a></li>
							</ul>
						</li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                <i class="fe fe-briefcase side-menu__icon"></i>
                                <span class="side-menu__label">{{__('messages.placement')}}</span></a>
                            <ul class="slide-menu">
                                <li><a href="{{route('wadmin.stockIn.place.view')}}" class="slide-item">{{__('messages.stock-in')}}</a></li>
                                <li><a href="{{route('wadmin.stockOut.place.view')}}" class="slide-item">{{__('messages.stock-out')}}</a></li>
                                <li><a href="{{route('wadmin.stockMove.place.view')}}" class="slide-item">{{__('messages.stock-move')}}</a></li>
                                <li><a href="{{route('wadmin.stock.place.history')}}" class="slide-item">{{__('messages.history')}}</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('wadmin.stock.warehouse')}}" class="slide-item">{{__('messages.stock-by-warehouse')}}</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('wadmin.new.order')}}" class="slide-item"> {{__('messages.new-orders')}}</a></li>
                                <li><a href="{{route('wadmin.order.management')}}" class="slide-item"> {{__('messages.manage-orders')}}</a></li>
                                <li><a href="{{route('wadmin.woo.refunded.order.list')}}" class="slide-item"> {{__('messages.refund-order')}}</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="{{route('wadmin.product.place.tracking.page')}}">
                                <i class="fe fe-briefcase side-menu__icon"></i>
                                <span class="side-menu__label">{{__('messages.product-tracking')}}</span></a>
                        </li>
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
								<i class="fe fe-briefcase side-menu__icon"></i>
							...
							<ul class="slide-menu">
								<li><a href="{{route('wadmin.profile')}}" class="slide-item">{{__('messages.my-profile')}}</a></li>
							</ul>
						</li>
					</ul>
				</aside>
												...
												<div class="d-flex order-lg-2">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                                @foreach (Config::get('languages') as $lang => $language)
                                                                    @if ($lang != App::getLocale())
                                                                        <a class="dropdown-item" href="{{ route('lang.switch', $lang) }}"><img src="{{asset ('a.pssets/images/flags/'.$language['flag-icon'].'.svg')}}" alt="flag" class="me-2 country"> {{$language['display']}}</a>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                        </li>
													...
													<div class="dropdown header-notify d-flex">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
															...
															<div class=" text-center p-2">
																<a href="{{route('wadmin.notifications')}}"
													...
													<div class="dropdown profile-dropdown d-flex">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
															...
															<a class="dropdown-item d-flex" href="{{route('wadmin.profile')}}">
				...
				<div class="container">
					<div class="row align-items-center flex-row-reverse">
						<div class="col-md-12 col-sm-12 text-center">
							{{__('messages.left-footer')}}
                            {{__('messages.right-footer')}}
						</div>
					</div>
				</div>
			</footer>
