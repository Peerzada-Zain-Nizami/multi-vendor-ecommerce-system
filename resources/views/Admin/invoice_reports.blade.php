        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">{{ __('messages.invoices-reports') }}</h4>
                </div>
            ...
            <div class="card" id="filter" @if ($filter != 1) style="display: none;" @endif>
                ...
                <form action="{{ route('admin.invoice.reports.filter') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-show-search" name="payment">
                                        <option value="" selected disabled>{{ __('messages.please-select') }}
                                        </option>
                                        <option value="Paid" {{ old('payment') == 'Paid' ? 'selected' : '' }}>
                                            {{ __('messages.paid') }}</option>
                                        <option value="Unpaid" {{ old('payment') == 'Unpaid' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Please Select" id="date" name="date" type="text"
                                        value="{{ old('date') ? old('date') : '' }}" class="form-control"
                                        autocomplete="off" />
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody id="result">
                                ...
                                @foreach ($results as $result)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('admin.user.view', ['id' => $result->suppliers_name[0]->id]) }}">{{ $result->suppliers_name[0]->name }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                echo "<a href='" .
                                                    route('admin.user.view', ['id' => $user->id]) .
                                                    "'>" .
                                                    $user->name .
                                                    '</a>';
                                            @endphp
