                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">{{__('messages.company-name')}}</label>
                                        <input type="text" class="form-control @if($errors->has('name'))is-invalid @endif" name="company_name" placeholder="{{__('messages.your-company-name')}}" value="{{Auth::user()->company_name}}">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('name'))is-invalid @endif" name="name" placeholder="Your {{__('messages.your-name')}}" value="{{Auth::user()->name}}">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @if($errors->has('phone_number'))is-invalid @endif" name="phone_number" placeholder="{{__('messages.phone-number')}}" value="{{Auth::user()->mobile_no}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('address'))is-invalid @endif" name="address" placeholder="{{__('messages.home-address')}}" value="{{Auth::user()->address}}">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('city'))is-invalid @endif" name="city" placeholder="{{__('messages.city')}}" value="{{Auth::user()->city}}">
                                        @if ($errors->has('city'))
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @if($errors->has('postal_code'))is-invalid @endif" name="postal_code" placeholder="{{__('messages.postal-code')}}" value="{{Auth::user()->postal_code}}">
...
@section('query')
    <script type="text/javascript">
                ...
                $.ajax({
                    url: '{{route('seller.profile.image')}}',
                    type: 'POST',
                    data: formData,
             ...
             $('.pass').click(function(){
                $.ajax({
                    url:'{{route('seller.profile.password')}}',
                    type:'POST',
                    data:$('#pass').serialize(),
                    success:function(response){
                        console.log(response);
