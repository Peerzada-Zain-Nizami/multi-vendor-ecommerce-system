...
@section('content')
    ...
    <div class="app-content main-content">
            ...
            <div class="col-sm-4 offset-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('seller.paypal.add')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label class="form-label">{{__('messages.paypal-email')}}</label>
        ...
        <!--div-->
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{__('messages.paypal-account-list')}}</div>
                </div>
                <div class="card-body">
                    <div class="">
                        <div class="table-responsive-lg">
                            <table id="example" class="table table-bordered text-nowrap key-buttons">
                                ...
                                <tr>
                                    ...
                                    <th class="border-bottom-0">{{__('messages.paypal-email')}}</th>
                                ...
                                @else
                                    <tr>
                                        <td colspan="13" class="text-center">{{__('messages.record-not-found')}}</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
